...
1. It seems the training is much faster, epoch 5 is comparable to epoch 9 in one char img.
Detail:
Trained on 1 img for 6 epoch.
Iters: 100 - 6 * i
Accumulations: 1

2. The truth is, in this experiment, all accuracy must be greater than 60% can it be regarded as working.
Result: It is not as desired, reaching around 50% for harder ones.
Detail:
Base: model after experiment 1
Trained on 1~3 img for 5 epoch
Iters: 128 - 6 * i
Accumulations: 3

3. 
Result: in the last 40 iters, all accuracy is above 60%. But still a little bit dangerous.
Detail:
Base: model after experiment 2
Trained on 1~3 img for 5 epoch
Iters: 128 - 6 * i
Accumulations: 4
...
4.
Result:
1. It seems that 128 - 6 * i has certern overfitting.
2. Reaching around 70% accuracy.
Detail:
Base: model after experiment 3
Trained on 3~5 img for 5 epoch
Iters: 128 - 6 * i
Accumulations: 4

5.
Result: Reached around 70% accuracy.
Detail:
Base: model after experiment 4
Trained on 4~8 img for 5 epoch
Iters: 100
Accumulations: 4

6.
Result: around 50% to 70% accuracy
Detail:
Base: model after experiment 5
Trained on 6~12 img for 5 epoch
Iters: 100
Accumulations: 4
